...
function Card({img,rating,reviews,title,price,open})
{
    console.log("hello")

    return(
        <div className=".card-holder">
            <div className="image-holder "style={{backgroundImage:`url(../assets/${img})`}}>
            <div className="image">
            {  open==0 &&  <div className="product-info"> <p className="req">Sold Out</p></div>}
                </div>
                <p className="info">
...
<span className="r-num">({reviews})</span>
