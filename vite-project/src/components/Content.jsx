...
function Content(props){
    ...
    <div className="content-holder">
     ...
     <div className="info-holder">
        <div className="extra">
     <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 7 10" fill="none"> 
 ...
 <span className="country">{props.location}</span>
    <a href={props.mapsUrl}>view on google </a>
    </div>
    <h1 className="title">{props.title}</h1>
    <h5 className="date">{props.start} - {props.end}</h5>
    <p className="info">
   {props.des}
    </p>
            </div>   
