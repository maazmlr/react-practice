...
function MainComponent(){
    return(
        <div className="main-comp">
            ...
            <h5 className="web">MuhammadMaaz.com</h5>
            <div className="button-cont">
            <button className="mail">
            <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="1.2rem" viewBox="0 0 17 16" fill="none">
...
<span className="text-mail">Email</span>
            </button>
            <button className="mail blue">
...
<span className="text-mail ">LinkedIn</span>
            </button>
            </div>
            <h2 className="about">
            About
